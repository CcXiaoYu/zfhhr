...
var url="http://zfos.xylrcs.cn/";

var iosUrl=url+'Home/PublicInterface/iphoneAuditNews';
	function J(o){
                ...
                if (strDM == 'ios') {
                    ...
                    if (numSV >= 7 && !fullScreen && iOS7StatusBarAppearance) {
                        //element.style.paddingTop = '20px';
												 element.style.paddingTop = api.safeArea.top + 'px';
                    }
                }
            },
						fixTabBar:function(el){
							var that=this;
								    if(!that.isElement(el)){
